...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-static --enable-shared --disable-network --disable-debug --enable-memalign-hack --enable-gpl --disable-avx --disable-fma4 --disable-programs --extra-cflags=-I../newlib/include --disable-pthreads --disable-w32threads --extra-cflags=-U_Win32 --extra-cflags=-U_WIN32 --extra-cflags=-U__MINGW32__ --enable-runtime-cpudetect --disable-encoders --disable-muxers --disable-protocols --enable-protocol=file --disable-devices --disable-postproc --disable-avfilter --disable-hwaccels
prefix=/usr/local
...
EXTRALIBS=-ldll -lz.dll -lc.dll -lgcc
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
